...
The NPÖ interview \cite{ViktorJernelov} was performed by two people, with one person being interviewed.The interview is transcribed to English and it is available in subsection ~\ref{sec:npoInterv} and ~\ref{sec:npoIntervi}. 
