...
\newglossaryentry{interoperability}{name={interoperability}, description={The ability of diverse systems and organizations to work together. Please see section~\ref{sec:interoperabilityDefinition} for the meaning within healthcare}}
...
\subsection{Definition within healthcare} %Define what interoperability is. Talk about interoperability in general, and also in this specific case. Why interoperability is important and how it works.
\label{sec:interoperabilityDefinition}

\subsection{Current situation} %What the current situation is regarding interoperability. Why it is a big problem.
...
%Subsections on different interoperability solutions.
