...
We also have some problems when it comes to the sharing of \glspl{EHR}, since the electronic interoperability is limited. When two hospitals need to share an \gls{EHR} it is done in two ways.\cite{EPJ2}
