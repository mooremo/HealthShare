...
\begin{description}
\item[Administrators] The main sections of interests is the sections on interoperability~\ref{sec:interoperability} (focus on 4.4 and 4.5). Skip the section on technical standards unless you are interested. Section six focuses on the adoption of a future system, read 6.2-6.4 about the non-technical issues. The results section is very important, focus on 7.1 and 7.2. Section eight describes the conclusions, read this.
