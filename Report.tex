...
Establishing an acceptable user-centered \gls{EHR} system is a challenging task for healthcare providers because there are many different stakeholders with different need. As stated the EHR workflow effects for the direct stakeholders (physicians, nurses, practitioners, etc.) may vary by type of patient care facility and professional responsibility. However, the most stated changes EHRs elevations involve increased efficiencies, improved accuracy, timeliness, availability and productivity \cite{Allan}.
...
Due to the large number of stakeholders and the workflow implications, it is of paramount importance to take into account that the new system must support the work processes of \glspl{HCP}. Apart from carefully designing the system interfaces based on successful standards and \gls{EHR} systems, standardized care plans should be established, to accomodate not only the interoperability issues but also streamlining the work and ensuring patient safety and equal care.

%TODO: write about (unifying) standards at global/regional level, the considerations mentioned at the end of the presentation, how the law is interpreted, the current disability of organizations to step forward (maybe relate to the microsoft/intel/ibm cooperation), and the vision
